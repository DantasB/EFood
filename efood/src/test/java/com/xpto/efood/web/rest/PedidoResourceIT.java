...
class PedidoResourceIT {
    ...
    private static final String DEFAULT_NOME_PEDIDO = "AAAAAAAAAA";
    private static final String UPDATED_NOME_PEDIDO = "BBBBBBBBBB";

    private static final Float DEFAULT_CUSTO_PEDIDO = 1F;
    private static final Float UPDATED_CUSTO_PEDIDO = 2F;
    ...
    public static Pedido createEntity(EntityManager em) {
        Pedido pedido = new Pedido().nomePedido(DEFAULT_NOME_PEDIDO).custoPedido(DEFAULT_CUSTO_PEDIDO);
        return pedido;
    }
    ...
    public static Pedido createUpdatedEntity(EntityManager em) {
        Pedido pedido = new Pedido().nomePedido(UPDATED_NOME_PEDIDO).custoPedido(UPDATED_CUSTO_PEDIDO);
        return pedido;
    }
    ...
    void createPedido() throws Exception {
        ...
        assertThat(testPedido.getNomePedido()).isEqualTo(DEFAULT_NOME_PEDIDO);
        assertThat(testPedido.getCustoPedido()).isEqualTo(DEFAULT_CUSTO_PEDIDO);
    }
    ...
    void getAllPedidos() throws Exception {
        ...
        restPedidoMockMvc
            ...
            .andExpect(jsonPath("$.[*].nomePedido").value(hasItem(DEFAULT_NOME_PEDIDO)))
            .andExpect(jsonPath("$.[*].custoPedido").value(hasItem(DEFAULT_CUSTO_PEDIDO.doubleValue())));
    }
    ...
    void getPedido() throws Exception {
        ...
        restPedidoMockMvc
            ...
            .andExpect(jsonPath("$.nomePedido").value(DEFAULT_NOME_PEDIDO))
            .andExpect(jsonPath("$.custoPedido").value(DEFAULT_CUSTO_PEDIDO.doubleValue()));
    }
    ...
    void putNewPedido() throws Exception {
        ...
        updatedPedido.nomePedido(UPDATED_NOME_PEDIDO).custoPedido(UPDATED_CUSTO_PEDIDO);
        ...
        Pedido testPedido = pedidoList.get(pedidoList.size() - 1);
        assertThat(testPedido.getNomePedido()).isEqualTo(UPDATED_NOME_PEDIDO);
        assertThat(testPedido.getCustoPedido()).isEqualTo(UPDATED_CUSTO_PEDIDO);
    }
    ...
    void partialUpdatePedidoWithPatch() throws Exception {
        ...
        partialUpdatedPedido.custoPedido(UPDATED_CUSTO_PEDIDO);
    ...
    void fullUpdatePedidoWithPatch() throws Exception {
        ...
        partialUpdatedPedido.nomePedido(UPDATED_NOME_PEDIDO).custoPedido(UPDATED_CUSTO_PEDIDO);
